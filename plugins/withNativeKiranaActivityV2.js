...
class MainActivity : Activity() {
    ...
    private fun showErrorPage() {
        val html = """
            ...
            </head><body><div class='card'><div class='logo'>K</div><h2>App connect nahi ho rahi</h2><p>Internet check karke dobara try karein.</p><a href='kirana://retry'>Dobara Kholein</a></div></body></html>
        """.trimIndent()
...
module.exports = function withNativeKiranaActivityV2(config) {
