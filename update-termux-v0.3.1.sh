...
set -e
ZIP="${1:-/storage/emulated/0/Download/kirana-software-v0.3.1-quantity-size-fix.zip}"
APP="$HOME/kirana-software"
TMP="$HOME/.kirana-update-v031"
...
echo "✅ Kirana Software v0.3.1 installed"
echo "✅ Quantity keyboard focus fixed"
echo "✅ Size / Pack option added"
