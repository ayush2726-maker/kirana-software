...
def stable_owner_page_with_item_merge_delete(token: str) -> HTMLResponse:
...
stable_owner.stable_owner_page = stable_owner_page_with_item_merge_delete
    ...
    if request.method == "GET" and request.url.path.rstrip("/") == "/owner-item-merge-delete.js":
        return Response(
            ...
            headers={
                ...
                "Pragma": "no-cache",
                "Expires": "0",
                "X-Kirana-Item-Merge-Delete": VERSION,
            },
        )
